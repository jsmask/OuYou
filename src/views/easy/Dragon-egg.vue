    ...
    <div class="main">
        <div class="egg-container" @click="active=!active" :class="{'active':active}">
            <div class="dragon">
                ...
                <div class="dragon-nose"></div>
                <div class="dragon-mouse">
                    <div class="dragon-tooth left"></div>
                    <div class="dragon-tooth right"></div>
                </div>
            </div>
            <div class="egg-wrapper"></div>
        </div>
    </div>
</template>
...
.dragon-eye::after{
    ...
    clip-path: ellipse(200% 15px at 10% 110%);
}
.dragon-eye.left{
    top:40px;
    left: 35px;
...
.dragon-nose{
    ...
    width: 30px;
    height: 10px;
    background: rgba(255,173,65,.5);
    left: 50%;
    top: 50%;
    transform: translate(-50%,-70%);
    border-radius:50% 50% 50% 50% / 20% 20% 50% 50%;
}
.dragon-nose::before{
    content: '';
    display: block;
...
.dragon-mouse{
    ...
    clip-path: ellipse(200% 28px at 50% 100%);
}
.dragon-tooth{
    display: block;
    box-sizing: border-box;
